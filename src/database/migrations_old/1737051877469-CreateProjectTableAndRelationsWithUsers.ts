  ...
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "users_projects_projects"
       (
    ...
    await queryRunner.query(
      `ALTER TABLE "users_projects_projects"
          ADD CONSTRAINT "FK_1adafab12f396fa125182f07564" FOREIGN KEY ("usersId") REFERENCES "users" ("id") ON DELETE CASCADE ON UPDATE CASCAD`,
    );
    await queryRunner.query(
      `ALTER TABLE "users_projects_projects"
          ADD CONSTRAINT "FK_a0922cc630203931d8048fce1da" FOREIGN KEY ("projectsId") REFERENCES "projects" ("id") ON DELETE NO ACTION ON UPDATE NO ACTIO`,
    );
  }
